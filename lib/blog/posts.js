const posts = [
  {
    slug: "the-panna-story",
    title: "The Panna Story: How a Tiger Reserve Came Back from Zero",
    date: "2026-08-19",
    location: "Panna Tiger Reserve, Madhya Pradesh",
    // Card subtitle on the blog list; excerpt stays the SEO/OG description.
    subtitle:
      "In 2009, Panna lost every one of its tigers to poaching. The comeback story of Panna is one everyone should be aware of.",
    excerpt:
      "In 2009, Panna lost every one of its tigers to poaching. The recovery that followed is one of the few real ones we can point at.",
    heroImage: {
      url: "https://res.cloudinary.com/duiyn8wll/image/upload/f_auto,q_auto/_Z9_20250508_TMH_8461_wm_vwr6rk",
      alt: "Tiger in the dry forests of central India",
    },
    content: [
      {
        type: "text",
        body: "In 2006, Panna had 24 tigers. Not a big number, but a working population. People went there to see them, and they saw them.",
      },
      {
        type: "text",
        body: "By January 2009, one male was left. After that month, nobody saw him again. Later that year, the Wildlife Institute of India put it in writing. Zero. Poachers had taken all of them. Panna was the second reserve in India where this happened. Sariska in Rajasthan was the first, a few years earlier.",
      },
      {
        type: "quote",
        text: "24 tigers is not a number that goes quietly.",
      },
      {
        type: "text",
        body: "I still find that hard to sit with. But, what happened after is the reason I visit this park. If you've seen the movie Seabiscuit, you'll know what I mean because Panna is all about a good comeback story!",
      },
      {
        type: "text",
        body: "They put tigers back. Two females came first, T1 from Bandhavgarh and T2 from Kanha. Then a male, T3, from Pench. All three wore radio collars, tracked around the clock.",
      },
      {
        type: "text",
        body: "T3 lasted about ten days. His collar went silent, and he walked out, heading towards Pench — the park he came from. Seventy forest staff and four elephants spent the next month looking for him, but what ended up working out was quite a simple solution. They sprayed an area with female tiger urine. It held him in one place long enough to be found. They brought him back. He took a territory and bred.",
      },
      {
        type: "text",
        body: "T1 had four cubs in April 2010. T2 had four more that October. By 2019, Panna had 54 tigers. Today the number is around 80. In 2020, UNESCO added Panna to its network of biosphere reserves.",
      },
      {
        type: "text",
        body: "One can argue why the population was ever allowed to dwindle and disappear, but we should feel proud of the effort gone into bringing Panna back on everyone's radar. So, if you've always thought of visiting Panna, but never took the plunge, this is your time!",
      },
    ],
  },
  {
...
export function getPostOgImage(post) {
  const url = post.heroImage
    ? post.heroImage.url
    : post.content.find((b) => b.type === "image")?.image.url;
  if (!url) return null;
  // Social cards require a fixed 1200x630 crop; swap out any inline
  // transformation component while leaving version segments intact.
  return url.replace(
    /\/upload\/(?:[^/]*[a-z]_[^/]*\/)?/,
