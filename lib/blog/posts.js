const posts = [
  {
    ...
    content: [
      ...
      {
        type: "text",
        body: "I still find that hard to sit with. But what happened after is the reason I picked this park.",
      },
      {
        type: "text",
      ...
      {
        type: "text",
        body: "You can argue about how the collapse was ever allowed to happen. But the recovery is real. There are not many of those to point at.",
      },
      {
        type: "text",
        body: "This is why I curate trips to Panna. Our October trip is sold out. The next one runs November 26–29. Six people maximum, two or three to a jeep, and I will be in the vehicle the whole time. Bookings close September 5th.",
      },
      {
        type: "cta",
