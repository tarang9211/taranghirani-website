...
const FACTS = [
  { label: "Dates", value: "Jan 21–24, 2027" },
...
export default function PannaJanWorkshopPage() {
  return (
    <>
      <Head>
                  ...
                  <div className="border-t border-charcoal/10 pt-12">
                    ...
                    <ul className="mt-4 space-y-2.5 text-sm leading-[1.6] text-smoke">
                      <li className="flex gap-3">
                        ...
                        <span>
                          Pune (PNQ) → Khajuraho (HJR), 21 Jan, morning
                          departure arriving by 12:15 pm, via Delhi
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <span
                        ...
                        <span>
                          Khajuraho (HJR) → Pune (PNQ), 24 Jan, afternoon
                          departure, via Delhi
                        </span>
                      </li>
                    </ul>
